...
|------|-----|--------------|
| Primary | `#2D5A1B` | `--color-primary` |
| On Primary | `#FFFFFF` | `--color-on-primary` |
| Secondary | `#8BC34A` | `--color-secondary` |
| Accent/CTA | `#C4834A` | `--color-accent` |
| Background | `#f4f1eb` | `--color-background` |
| Foreground | `#0F172A` | `--color-foreground` |
| Muted | `#e8e4d9` | `--color-muted` |
| Border | `#ded8cb` | `--color-border` |
| Destructive | `#DC2626` | `--color-destructive` |
| Ring | `#2D5A1B` | `--color-ring` |

**Color Notes:** Israeli Agricultural Green + Warm Earth/Cream
